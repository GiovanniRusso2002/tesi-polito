...
For the data layer, the strategy applied the incremental coexistence model defined in Section~\ref{sec:data-layer-options}, building on the PostgreSQL target identified in Chapter~\ref{chap:baseline}.
