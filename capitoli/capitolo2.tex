...
The contribution of the work is not limited to the description of a target AWS architecture. Instead, it analyzes the migration of a production platform from a virtual-machine-based environment hosted on DigitalOcean Droplets toward a cloud-native architecture built on managed AWS services. The thesis also emphasizes the reasoning process that connects baseline system limitations, migration decisions, infrastructure automation, coexistence management, and validation workflows.
