...
The limitations of the legacy datastore described in Chapter~\ref{chap:baseline} shifted the evaluation away from the question of whether PostgreSQL should be adopted and toward the more practical question of \emph{how} to transition toward the target relational model.
