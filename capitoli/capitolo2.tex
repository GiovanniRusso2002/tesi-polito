...
Consequently, the migration should not be viewed as a simple infrastructure relocation, but as a controlled modernization process combining replatforming and selective refactoring to improve scalability, maintainability, and operational sustainability.
